...
function draw() {
  ...
  fill(255);
  ellipse(data.bodypoints[3].x,data.bodypoints[3].y, 5, 10);
  ellipse(data.bodypoints[4].x,data.bodypoints[4].y, 5, 10);

  circle(297, 86, 42);

  circle(data.bodypoints[0].x,data.bodypoints[0].y, 7);
  circle(data.bodypoints[2].x,data.bodypoints[2].y, 8);
  circle(data.bodypoints[1].x,data.bodypoints[1].y, 8);

  fill(0);
  circle(data.bodypoints[1].x,data.bodypoints[1].y, 3);
  circle(data.bodypoints[2].x,data.bodypoints[2].y, 3);
